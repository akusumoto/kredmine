...
function jsToolBar(textarea) {
	...
	this.context = null;
	this.toolNodes = {}; // lorsque la toolbar est dessin辿e , cet objet est garni 
					// de raccourcis vers les 辿l辿ments DOM correspondants aux outils.
}
	...
	draw: function(mode) {
		...
		for (var i in this.elements) {
			...
			if (!disabled && typeof this[b.type] == 'function') {
				...
				if (newTool) {
					this.toolNodes[i] = newTool; //m辿morise l'acc竪s DOM pour usage 辿ventuel ult辿rieur
